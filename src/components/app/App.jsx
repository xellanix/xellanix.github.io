		...
		<SmoothScroll>
			...
			>
				<LazyMotion features={domAnimation}>
					...
					<main ref={container}>
						...
						>
							<div id="hero-content">
								...
								<h6>
									Build your programming projects faster and
									easier than ever.
								</h6>
								{isCollapsed && (
									<img
						...
						>
							...
							>
								...
								<p>
									Xellanix Community (2022) is an independent
									public benefit community with the purpose to
									provide a complete, free and open source
									projects and libraries.
									<br />
									We are also established to have a positive
									impact on many people, especially
									programmers, in utilizing a programming
									language for their projects.
									<br />
									Xellanix continues to strive for relevance
									in its active projects and libraries, aiming
									to provide ongoing convenient and positive
									feedback regarding our development.
								</p>
							</m.div>
							<m.div
							...
							>
								...
								>
									...
									<p>
										Our Vision is to provide convenience to
										everyone in working on their projects in
										specific programming languages for free.
										<br />
										As part of our vision, the Xellanix
										Community was formed with mission to
										offer relevant and user-friendly
										projects and libraries for free.
									</p>
								</m.div>
								<m.div
									className="vertical-layout flex-fill animate-right-to-in"
								...
								>
									<h2>Our Goals</h2>
									<p>
										Maintain and enhance Xellanix projects
										and libraries through a publicly
										accessible source code system under the
										MIT License.
										<br />
										Provide researchers and programmers,
										both individuals and teams, access to
										complete, free and open source projects
										and libraries
									</p>
								</m.div>
							</m.div>
						...
						>
							...
							>
								...
								<m.p variants={motionYN}>
									“We build this community with you, as by
									doing so,
									<br />
					...
					>
						{isPopupOpened && (
							<PopupSection setIsPopupOpened={setIsPopupOpened}>
								{popupItem}
							</PopupSection>
						)}
					</div>
